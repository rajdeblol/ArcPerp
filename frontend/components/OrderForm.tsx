...
export function OrderForm({ traderPubkey, mxePublicKey, onEncryptedSubmit }: Props): ReactElement {
  ...
  return (
    <form className="surface-card order-form" onSubmit={handleSubmit}>
      ...
      <label>
        Direction
        <select value={direction} onChange={(e) => setDirection(e.target.value as OrderDirection)}>
